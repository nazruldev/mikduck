(() => {
  ...
  const dict = {
    id: {
      ...
      'home.featuresLead': 'MVP siap untuk operasional warnet & hotspot harian — tanpa setup PHP/Apache.',
      ...
      'home.f3Title': 'Profile & user hotspot',
      'home.f3Body': 'Bandwidth profile, enable/disable user, cookies, DHCP leases, tools.',
      'home.f4Title': 'Finance & multi-router',
      'home.f4Body': 'Rekap penjualan voucher, simpan beberapa router, ganti perangkat cepat.',
      'home.f5Title': 'Hak akses granular',
      'home.f5Body': 'Login UAM: batasi generate, hapus, atau print per operator.',
      'home.f6Title': 'Desktop native',
      'home.f6Body': 'Electron + FastAPI + React. Install, connect API :8728, langsung kerja.',
      'home.vsTitle': 'mikduck vs MikhMon',
      'home.vsLead': 'Alur kerja familiar — kemasan & pengalaman beda total.',
      'home.vsDuckMeta': 'Desktop open source · 2026',
      'home.vsDuck1': 'Installer Windows & Linux — tanpa PHP',
      'home.vsDuck2': 'React + FastAPI + Electron',
      'home.vsDuck3': 'Dashboard WebSocket realtime',
      'home.vsDuck4': 'Light/Dark · bahasa ID/EN',
      'home.vsDuck5': 'Hak akses UAM granular',
      'home.vsDuckCta': 'Unduh mikduck',
      'home.vsMonMeta': 'Web PHP klasik · referensi komunitas',
      'home.vsMon1': 'Butuh Apache/Nginx + PHP',
      'home.vsMon2': 'PHP + JavaScript di browser',
      'home.vsMon3': 'Live report / polling',
      'home.vsMon4': 'UI web klasik',
      'home.vsMon5': 'Admin-style, matang di lapangan',
      'home.vsFootnote': 'mikduck menghormati MikhMon sebagai referensi alur — bukan pengganti wajib.',
    ...
    en: {
      ...
      'home.featuresLead': 'MVP ready for daily warnet & hotspot ops — no PHP/Apache setup.',
      ...
      'home.f3Title': 'Hotspot profiles & users',
      'home.f3Body': 'Bandwidth profiles, enable/disable users, cookies, DHCP leases, tools.',
      'home.f4Title': 'Finance & multi-router',
      'home.f4Body': 'Voucher sales summary, save multiple routers, switch devices fast.',
      'home.f5Title': 'Granular access',
      'home.f5Body': 'UAM login: limit generate, delete, or print per operator.',
      'home.f6Title': 'Native desktop',
      'home.f6Body': 'Electron + FastAPI + React. Install, connect API :8728, get to work.',
      'home.vsTitle': 'mikduck vs MikhMon',
      'home.vsLead': 'Familiar workflow — packaging and experience are different.',
      'home.vsDuckMeta': 'Open-source desktop · 2026',
      'home.vsDuck1': 'Windows & Linux installer — no PHP',
      'home.vsDuck2': 'React + FastAPI + Electron',
      'home.vsDuck3': 'Realtime WebSocket dashboard',
      'home.vsDuck4': 'Light/Dark · ID/EN language',
      'home.vsDuck5': 'Granular UAM permissions',
      'home.vsDuckCta': 'Download mikduck',
      'home.vsMonMeta': 'Classic PHP web · community reference',
      'home.vsMon1': 'Needs Apache/Nginx + PHP',
      'home.vsMon2': 'PHP + JavaScript in the browser',
      'home.vsMon3': 'Live report / polling',
      'home.vsMon4': 'Classic web UI',
      'home.vsMon5': 'Admin-style, battle-tested in the field',
      'home.vsFootnote': 'mikduck respects MikhMon as a workflow reference — not a mandatory replacement.',
      'home.partnersTitle': 'Our Partners',
